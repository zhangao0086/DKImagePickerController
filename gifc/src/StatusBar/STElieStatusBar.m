...
//    MMMaterialDesignSpinner *_spinner;
    STGIFCAnimatableLogoView * _elie;
...
- (void)createContent; {
    ...
    STGIFCAppSetting * pref = STGIFCAppSetting.get;
...
//    _elie.size = _elie.image.size;
    ...
    _elie = [[STGIFCAnimatableLogoView alloc] initWithSizeWidth:self.height/2];
...
- (void)didCreateContent; {
    ...
    /*
        init observer
     */
    [STGIFCAppSetting.get whenSavedToAll:self.identifier withBlock:^(NSString *property, id value) {
    ...
    [[STGIFCAppSetting.get st_propertyNames] bk_each:^(id obj) {
        [weakSelf applyFromPreference:obj value:[STGIFCAppSetting.get valueForKey:obj]];
    }];
