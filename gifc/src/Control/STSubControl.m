...
//            }];
//        }];
////        _right.currentIndex = (NSUInteger) [[[STGIFCAppSetting get] read:@keypath([STGIFCAppSetting get].photoSource)] integerValue];
...
//            }
        ...
        _right.currentMappedValue = @(STGIFCAppSetting.get.postFocusMode);
        [_right whenSelectedWithMappedValue:^(STSelectableView *_button, NSInteger index, id value) {
            STGIFCAppSetting.get.postFocusMode = [value integerValue];
...
//            [self.class setExtractRetractForPostFocusMode:_right postFocusMode:[_right.currentMappedValue integerValue] animation:YES];
            ...
            NSString * labelPostFocusMode = [STGIFCAppSetting.get labelForPostFocusMode:(STPostFocusMode) [value integerValue]];
...
//            STGIFCAppSetting.get.afterManualCaptureAction = [value integerValue];
//        }];
//
//        _right.collectablesSelectAsIndependent = NO;
...
- (STStandardNavigationButton * )_setNeedsCollectablesForAutoEnhanceInEditMode:(STStandardNavigationButton *)target {
    ...
    target.collectableSelectedState = [[STGIFCAppSetting.get read:@keypath([STGIFCAppSetting get].autoEnhanceEnabledInEdit)] boolValue];
    [target whenCollectableSelected:^(STStandardButton *collectableButton, NSUInteger index) {
        STGIFCAppSetting.get.autoEnhanceEnabledInEdit = target.collectableSelectedState;
