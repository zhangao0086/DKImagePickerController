...
//        if([STGIFFApp isDebugMode] || STGIFFAppSetting.get.isFirstLaunch){
...
//                [button setButtons:@[[R ico_play]] colors:nil];
                ...
                [button setButtons:@[[STGIFFApp livePhotosBadgeImageName]] colors:@[[UIColor whiteColor]] bgColors:@[[STStandardUI iOSSystemCameraHighlightColor]] style:STStandardButtonStylePTBT];
...
- (void)dettachQuickPreviewView:(BOOL)enteredZoomScrollMode {
    ...
    [STGIFFApp logQuickPreviewDismissed:enteredZoomScrollMode];
}
