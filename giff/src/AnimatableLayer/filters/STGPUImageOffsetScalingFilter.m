...
NSString *const kSTGPUImageOffsetScalingFilter = SHADER_STRING
(
...
@interface STGPUImageOffsetScalingFilter()
{
    GLint blurSizeUniform, blurCenterUniform;
}
@end

@implementation STGPUImageOffsetScalingFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kSTGPUImageOffsetScalingFilter]))
    {
        return nil;
    }
