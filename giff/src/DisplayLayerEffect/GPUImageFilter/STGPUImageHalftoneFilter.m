...
NSString *const kSTGPUImageHalftoneFragmentShaderString = SHADER_STRING
(
...
@implementation STGPUImageHalftoneFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kSTGPUImageHalftoneFragmentShaderString]))
    {
        return nil;
    }
